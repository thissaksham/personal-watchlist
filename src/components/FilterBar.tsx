...
// Props for the Expandable Filter Item
    ...
    return (
        <div className="filter-group" ref={containerRef}>
            ...
            <div className={`options-inline ${isOpen ? 'active' : ''}`}>
                {/* Always include an 'All' option if not explicitly provided. 'all' or null ID means All. */}
                        ...
                        {option.image && (
                            <img
                                ...
                                style={{
                                    ...
                                    height: '20px',
                                    borderRadius: '6px',
                                    objectFit: 'contain' // Ensures wide logos shrink to fit without cropping
                                }}
                            />
                        )}
                        {option.label}
