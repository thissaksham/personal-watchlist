                ...
                <div className="modal-body relative">
                    <div className="u-vstack">
                        {type === 'tv' && (details?.seasons || media.seasons) && (
                            <div style={{ marginBottom: '0px', width: '100%' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start', gap: '12px', padding: '12px', margin: '-12px' }} onMouseLeave={() => setHoveredSeason(null)}>
                    ...
                    <div className="u-vstack">
                        ...
                        {providers.length === 0 && (
                            <div>
                                <h3 className="section-title text-sm uppercase tracking-wider text-gray-500 mb-3 mt-4">
                                    <div className="flex items-center gap-2"><PlayCircle size={16} />Download From</div>
                                </h3>
                                <div className="provider-list">
